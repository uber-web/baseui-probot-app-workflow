...
APP_URL=$(now --npm -t $NOW_TOKEN --public -e $PRIVATE_KEY -e BUILDKITE_TOKEN=@buildkite-token -e $APP_ID -e $WEBHOOK_SECRET -e NODE_ENV="production" -e PUBLISH_ARGS="dist")
